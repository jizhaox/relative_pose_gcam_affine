...
int main(int argc, char* argv[]){
	...
	double *Image1 = new double[6];
	double *Image2 = new double[6];
	double *At_33 = new double[18];
	...
	// load data
	load_input_data4d(argv[1], Image1, Image2, At_33, R_cam, t_cam, R_gt, t_gt);
	
	// Relative Pose Estimation with Known Vertical Direction: 2AC vertical solver
	std::vector<Eigen::Matrix3d> Rf1tof2_recover;
	std::vector<Eigen::Vector3d> Tf1tof2_recover;
    
        solver_ac_pose4d(Rf1tof2_recover, Tf1tof2_recover, Image1, Image2, At_33, R_cam, t_cam, "intra");
